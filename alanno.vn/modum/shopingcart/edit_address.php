...
<?php echo $html->normalForm("frmaddress",array("action"=>"checkout.html","method"=>"post"));?>
...
<div class="right_row2">
  <input class="full" style="width:200px" type="text" onfocus="this.select();" value="<?php echo $member_info["postcode"]?>" name="postcode" id="postcode"  />  <span class="txtdo">*</span>
...
<?php
      ...
      while($row = $dbf->nextData($rstCountry))
       {
          echo'<option '.(($member_info["country_id"]==$row['id'])?"selected":"").' value="'.$row['id'].'">'.$row['countries_name'].'</option>';
       }
...
<div class="right_row1"><?=$words["POSTCODE"]?></div>
<div class="right_row2">
  <input class="full" style="width:200px" type="text" onfocus="this.select();" value="<?php echo $shipping_address["postcode"]?>" name="shipping_postcode" id="shipping_postcode"  />  <span class="txtdo">*</span>
...
<?php
      ...
      while($row = $dbf->nextData($rstCountry))
       {
          echo'<option '.(($shipping_address["country_id"]==$row['id'])?"selected":"").' value="'.$row['id'].'">'.$row['countries_name'].'</option>';
       }
...
<div class="clear"></div>
<input type="submit" name="cmdupdate_address_shipping" id="cmdupdate_address_shipping" value="<?=$words["CONTINUE_CHECKOUT"]?>" />
