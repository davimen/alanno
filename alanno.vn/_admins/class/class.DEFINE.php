...
**************************************************************/
 ...
 define("insertText","<a title='Insert' id='lnkaction' href='?".QUERY_STRING."&insert'>Thêm</a>");

 define("insertText2","<a title='Insert' onClick='showtextalert()' id='lnkaction' href='javascript:void(0)'>Thêm</a>");
 ...
 define("selectText","<a title='Chọn tin' id='lnkaction' onclick=\"docheck(!document.frm.chkall.checked,2);\" href='javascript:void(0);'>Chọn</a>");
 ...
 define("deleteText","<a title='Delete' id='lnkaction' href='javascript:void(0);' onclick=\"return deleteCommon('?".QUERY_STRING."');\">Xoá</a>");
...
global $arrayLog;
$arrayLog=array("ipaddress"=>$_SERVER['REMOTE_ADDR'],"host"=>$_SERVER['HTTP_HOST'],
                "referrer"=>$_SERVER['REQUEST_URI'],"dating"=>time(),
                "useragent"=>$_SERVER['HTTP_USER_AGENT'],
                "remotehost"=>getHostByAddr($_SERVER['REMOTE_ADDR']),
                "action"=>"view","deleting"=>0,
                "content"=>"","tablename"=>"",
 ...
 $arrayHeader=array("utf8"=>"utf-8","refresh"=>"3600",
                    ...
                    "keywords"=>"Administrator","description"=>"www.giaiphaptoiuu.net, www.giaiphaptoiuu.net","copyright"=>"www.giaiphaptoiuu.net");
?>