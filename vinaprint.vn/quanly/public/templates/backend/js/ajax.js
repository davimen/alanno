...
$(document).ready( function () {
    ...
    if(window.location.pathname == '/quanly/backend/product'){
    ...
    if(window.location.pathname == '/quanly/backend/order'){
        cms_load_listorders();
    }
    if(window.location.pathname == '/quanly/backend/import'){
        cms_load_listimports();
    }
    if(window.location.pathname == '/quanly/backend/inventory'){
        cms_load_listInventory();
    }
    if(window.location.pathname == '/quanly/backend/config'){
        cms_crfunc();
        cms_upfunc();
        cms_crgroup();
        cms_radiogroup();
    ...
    if(window.location.pathname == '/quanly/backend/customer'){
        ...
        var $param = {
            ...
            'callback': function (data) {
                if (data == '0') {
                    ...
                    cms_javascript_redirect( 'http://localhost/quanly/backend/customer/index');
                }
            }
        };
        cms_adapter_ajax($param);
