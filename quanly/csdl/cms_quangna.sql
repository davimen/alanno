...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 22, 2016 at 10:49 AM
...
CREATE TABLE IF NOT EXISTS `cms_import_stock` (
`ID` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cms_manufactures` (
`ID` int(10) unsigned NOT NULL,
...
(1, 'Adminstrator', '4bc845f46336a78f9c8e5e52f4c3f544', 'Xy(M!6CpqgZv#wvyJA$UFkbWGe4$#M@&sbrKIw(d6KF@&H)Bz7PKeakCuCNqvEJ^1w!ce', 'frdevhero@gmail.com', 'Phạm Văn Quang', 1, 1, 1, '2016-05-03 23:11:27', '2016-06-17 11:16:14', '2016-06-22 13:25:45.0', '::1', '', ''),
...
ALTER TABLE `cms_manufactures`
 ADD PRIMARY KEY (`ID`), ADD KEY `manuf_name` (`manuf_name`), ADD KEY `manuf_phone` (`manuf_phone`);
